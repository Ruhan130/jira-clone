...
export const WorkspaceIdClient = () => {
    ...
    const { data: tasks, isLoading: isTaskLoading } = useGetTasks({ workspaceId, assigneeId: currentMember?.$id });
        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-muted rounded-lg p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button variant="muted" size="icon" onClick={() => router.push(`/workspaces/${workspaceId}/create-task`)} >
        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-white border rounded-lg p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button variant="secondary" size="icon" onClick={() => router.push(`/workspaces/${workspaceId}/create-new-project`)} >
                        <PlusIcon className="size-4 text-neutral-400" />
                    </Button>
                </div>
                <DottedSeperator className="my-4" />
