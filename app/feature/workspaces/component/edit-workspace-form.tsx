...
export const EditWorkSpaceForm = ({ onCancel, initialValues }: EditWorkSpaceForm) => {
    ...
    const iniviteFullLink = `${window.location.origin}/workspaces/${initialValues.$id}/join/${initialValues.workspaceUrl}`;
    //   const iniviteFullLink = `${window.location.origin}/workspaces/${workspaceId}/join/${workspace?.workspaceUrl}`;
