...
export const TaskActions = ({ id, projectId, children }: TaskActionProps) => {
    ...
    const [ConfirmationDailogue, confirm] = useConform(
        "Delete task",
    ...
    const editTaskRoute = () => {
        router.push(`/workspaces/${workspaceId}/projects/${projectId}/tasks/${id}/edit-task`);
    }
